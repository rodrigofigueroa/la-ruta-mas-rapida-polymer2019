...
// import {menuIcon} from './utils/mycamion-app-icons.js';

class MycamionApp extends connect(store)(LitElement) {
    ...
    return html`
      ...
      <footer class="footer-app">
        <div class="container-footer">
          <p>La ruta extrema; by team Los Guaches.</p>
        </div>
      </footer>
    `;
  }
...
window.customElements.define('mycamion-app-app', MycamionApp);
